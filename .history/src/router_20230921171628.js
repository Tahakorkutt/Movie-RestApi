...
const {updatePasswordUser, userDetail, updateUserDetail,facebookLoginCallback,facebookLogin,googleLoginCallback,googleLogin, registerUser, loginUser, logoutUser, deleteUser} = require('./handlers/user/user_handler');
